...
public class StackTest {
    ...
    private static IStack<String> target;
    ...
    {
      pushMany();
      Assert.assertEquals(control.get(4), target.pop());
    }
    ...
    public void testPopsAfterPushMany()
    {
      pushMany();
      target.pop();
      Assert.assertEquals(control.get(3), target.pop());
    }
    ...
    public void testToStringAfterPushAndPop()
    {
      pushMany();
      target.pop();
      Assert.assertEquals("[Fourth, Third, Second, First]", target.toString());
    }
    ...
    public void testPopPopPushPopPopAfterPushMany()
    {
      ...
      target.pop();
      target.pop();
      Assert.assertEquals(control.get(1),target.peek());
    }
    ...
    public void testPopPopPushPopPopStructureAfterPushMany()
    {
      ...
      Assert.assertEquals(control.get(1),list.get(0));
      Assert.assertEquals(control.get(0),list.get(1));
